package com.pmdm.basesdedatos.adaptadores;
...
import com.pmdm.basesdedatos.R;
import com.pmdm.basesdedatos.entidades.Contactos;
import com.pmdm.basesdedatos.VerActivity;
...
public class ListaContactosAdapter extends RecyclerView.Adapter<ListaContactosAdapter.ContactoViewHolder> {
    ...
    public class ContactoViewHolder extends RecyclerView.ViewHolder {
        ...
        public ContactoViewHolder(@NonNull View itemView) {
            ...
            viewNombre.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {

                    Context context = view.getContext();
                    Intent intent = new Intent(context, VerActivity.class);
                    int iD = listaContactos.get(getAdapterPosition()).getId();
